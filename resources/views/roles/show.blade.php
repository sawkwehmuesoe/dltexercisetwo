...
@section('caption','Role Show List')
@section('content')
                    ...
                    <div class="card rounded-0">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <i class="fas fa-calendar-alt fa-sm"></i><span>{{date('d M Y',strtotime($role->created_at))}} {{date('h:i:s A',strtotime($role->created_at))}}</span>
                                    <br/>
