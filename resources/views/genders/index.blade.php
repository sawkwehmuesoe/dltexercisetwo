            ...
            <table id="mydata" class="table border table-sm table-hover border">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:void(0);" class="text-infod editform" data-bs-toggle="modal" data-bs-target="#editmodal" data-id="{{$gender->id}}" data-name="{{$gender->name}}" ><i class="fas fa-pen"></i></a>
