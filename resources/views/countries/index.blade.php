...
@section('caption','Countries List')
@section('content')
            ...
            <table id="mydata" class="table border table-sm table-hover border">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:void(0);" class="text-infod editform" data-bs-toggle="modal" data-bs-target="#editmodal" data-id="{{$country->id}}" data-name="{{$country->name}}" ><i class="fas fa-pen"></i></a>
