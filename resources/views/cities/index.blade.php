            ...
            <table id="mydata" class="table border table-sm table-hover border">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:void(0);" class="text-infod editform" data-bs-toggle="modal" data-bs-target="#editmodal" data-id="{{$city->id}}" data-name="{{$city->name}}" ><i class="fas fa-pen"></i></a>
                        ...
                        <form id="formaction" action="" method="POST">
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="name"  id="editname" class="form-control form-control-sm rounded-0" placeholder="Enter city Name..." value="{{old('name')}}" />
                                </div>
